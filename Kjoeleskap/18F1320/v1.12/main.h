...
******************************************************************************/
#define VDD_SF 4808 // 4.918V (240V, normal operation) + 1 grad
...
#define FREEZER_RUN_TEMP_OFFSET 15 //17  pga sensor plassert i grillene (lavere stopper tidligere)
#define FREEZER_STOP_TEMP_OFFSET 2 //4 avg når grillen tempereres (lavere starter senere)
...
#define FRIDGE_RUN_TEMP_OFFSET -4  // -3 lat som varmere, pga sensor plassert på kaldt sted...vifte blåser kulde
#define FRIDGE_STOP_TEMP_OFFSET -6 //-4 lat som kaldere
...
int1 do_read_temp, do_LED_updates, blink_toggle, blink_toggle_fast;
