...
******************************************************************************/
#define VDD_SF 4858 // 4.XXXV (240V, normal operation) prev: 4868 4.979V 
...
#define FREEZER_RUN_TEMP_OFFSET 8 //5 pga sensor plassert i grillene (lavere stopper tidligere)
#define FREEZER_STOP_TEMP_OFFSET -1 // avg når grillen tempereres (lavere starter senere)
...
#define FRIDGE_RUN_TEMP_OFFSET -5  // lat som varmere, pga sensor plassert på kaldt sted...vifte blåser kulde
#define FRIDGE_STOP_TEMP_OFFSET -7 // lat som kaldere
