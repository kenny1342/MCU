...
#define FREEZER_RUN_TEMP_OFFSET 15 //16  pga sensor plassert i grillene    -18 etter 5 min, -19 e 6    
#define FREEZER_STOP_TEMP_OFFSET 3 //4 avg når grillen tempereres
...
#define FRIDGE_RUN_TEMP_OFFSET -2  // -1 lat som varmere, pga sensor plassert på kaldt sted...vifte blåser kulde
