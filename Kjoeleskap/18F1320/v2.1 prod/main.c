...
TODO's
- CHANGE Started1 and Started2 from int8 to int16 (for webpage) - 10.09.2011
- ADD version in serial output - 10.09.2011
- ADD **START CYCLE** in serial output - 10.09.2011
- ADD [FR] in beginning of every serial output (for separating at webserver with multiple RS232 wireless clients) - 10.09.2011
- CHANGE minute counter (total run etc) to a timestruct with days - 10.09.2011
