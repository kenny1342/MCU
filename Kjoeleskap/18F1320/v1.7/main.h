...
#define FREEZER_RUN_TEMP_OFFSET 16 // 14 pga sensor plassert i grillene    -18 etter 5 min, -19 e 6    
...
typedef struct
{
    ...
    int8 fridge_total_run_mins;
    int8 freezer_run_mins;
    int8 freezer_total_run_mins;
...
//unsigned int8 CONST STR_FRIDGE_FREEZER[15] = {"Fridge/Freezer"};
