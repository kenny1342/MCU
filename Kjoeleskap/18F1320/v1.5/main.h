...
#define SW_MINOR_V (int8) 05                 // using date while under development...
...
#define FRIDGE_RUN_TEMP_OFFSET 0  // lat som varmere, pga sensor plassert på kaldt sted...vifte blåser kulde
#define FRIDGE_STOP_TEMP_OFFSET -4 //-3 -4 8+=1
...
//#define BLINK_HALF_HERTZ          // blink LEDs at 0.5Hz, comment out for 1Hz
