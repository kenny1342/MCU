...
#define SW_MINOR_V (int8) 06                 
#define HW_MAJOR_V (int8) 01
#define HW_MINOR_V (int8) 06

// Ref. voltage used in math in ADC stuff, kaldere når lavere
//#define VDD 5.0
//#define VDD 4.72 // (ICD2)
#define VDD 4.9 //4.87 (240V, normal operation w/power supply)
...
#define SAMPLE_INTERVAL_SECS  10  // (ISR TIMER1 sets interval)
...
#define FREEZER_DEGREES_OVER  3    // 2 degrees diff between pot and real temp before starting
#define FREEZER_RUN_TEMP_OFFSET 14 //// pga sensor plassert i grillene    -18 etter 5 min, -19 e 6    
#define FREEZER_STOP_TEMP_OFFSET 4 //// avg når grillen tempereres
...
#define FRIDGE_RUN_TEMP_OFFSET -1  // 0 lat som varmere, pga sensor plassert på kaldt sted...vifte blåser kulde
#define FRIDGE_STOP_TEMP_OFFSET -4 //-3 
...
int1 do_read_temp, blink_toggle, blink_toggle_fast;


unsigned int8 ISR_counter1, sample_timer_sec;
/*#ifndef BLINK_HALF_HERTZ 
  unsigned int8 ISR_counter3;
#endif
*/
...
//unsigned int8 fridge_run_mins, freezer_run_mins;
...
static volatile signed int8 min_val, max_val;//, min_val_fridge, max_val_fridge;
