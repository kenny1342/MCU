...
#define FREEZER_RUN_TEMP_OFFSET 13 //10 pga sensor plassert i grillene (lavere stopper tidligere)
#define FREEZER_STOP_TEMP_OFFSET 2 //0 avg når grillen tempereres (lavere starter senere)
...
#define FRIDGE_DEGREES_OVER  1    //TRY 2 real temp degrees over pot before starting
#define FRIDGE_RUN_TEMP_OFFSET -6  //-3 (lavere stopper tidligere)
#define FRIDGE_STOP_TEMP_OFFSET -8 //-6 (lavere starter senere)
