...
#define SW_MINOR_V (int8) 01 //stockholm release... 28 nov - 2 des                
...
static const int16 PotFridgeLevels[7] = {315,350,390,505,600,700,200};
static const int16 PotFreezerLevels[9] = {260,285,345,415,485,595,645,715,200};
