...
******************************************************************************/
#define VDD_SF 4868 // 4.979V (240V, normal operation) prev: 4808 4.918V 
...
#define FREEZER_RUN_TEMP_OFFSET 10 //13 15 17  pga sensor plassert i grillene (lavere stopper tidligere)
#define FREEZER_STOP_TEMP_OFFSET 3 //OK  4 avg når grillen tempereres (lavere starter senere)
...
#define FRIDGE_RUN_TEMP_OFFSET -3  //-1 -2 -4 -3 lat som varmere, pga sensor plassert på kaldt sted...vifte blåser kulde
#define FRIDGE_STOP_TEMP_OFFSET -7 //-3 -2 -6 -4 lat som kaldere
