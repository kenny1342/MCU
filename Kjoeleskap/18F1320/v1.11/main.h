...
******************************************************************************/
#define VDD_SF 4808 // 4.9V (240V, normal operation) + 1 grad
//#define VDD_SF 4680 // 4.7V (ICD2)
...
#define FREEZER_RUN_TEMP_OFFSET 17 //16  pga sensor plassert i grillene    -18 etter 5 min, -19 e 6    
#define FREEZER_STOP_TEMP_OFFSET 4 //3 avg når grillen tempereres
...
#define FRIDGE_RUN_TEMP_OFFSET -3  // -1 lat som varmere, pga sensor plassert på kaldt sted...vifte blåser kulde
#define FRIDGE_STOP_TEMP_OFFSET -4 //-4 lat som kaldere
