...
#define DEF_CONF_WP_LOWER           3.35 // water pressure lower threshold (bar*100) before starting pump
#define DEF_CONF_WP_UPPER           4.00 // water pressure upper threshold (bar*100) before stopping pump
#define DEF_CONF_WP_MAX_RUNTIME     1800L  // max duration we should let pump run (seconds) (1800=30min)
#define DEF_CONF_WP_SUSPENDTIME     600L  // seconds to wait after alarms are cleared before we start pump again
